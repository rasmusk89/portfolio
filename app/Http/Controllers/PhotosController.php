...
class PhotosController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect('gallery/albums/' . $request->input('album_id'))->with('success', __('messages.photo_uploaded') . '!');
    }
    ...
    public function destroy($id) {
        ...
        if (Storage::delete('public/photos/'.$photo->album_id.'/'.$photo->photo)) {
            ...
            return redirect('/gallery/albums/'.$photo->album_id)->with('success', __('messages.photo_deleted') . '!');
        }
    }
